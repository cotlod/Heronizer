package combat.skill 
{
	 ...
	 * @author 
	 */
	public class RoidUpSkill extends Skill
	{
		...
		public function RoidUpSkill() 
		{
			super(ESkill.ROID_UP);
			
			mStateList.length = 0;
			
			mStateList.push(new State(EState.IDLE, PlayerAsset.IDLE_ROID_UP));
			mStateList.push(new State(EState.ATTACK, PlayerAsset.STRIKE_ROID_UP));
