package combat.skill 
{
	 ...
	 * @author 
	 */
	public class PincerSkill extends Skill
	{
		...
		public function PincerSkill() 
		{
			super(ESkill.PINCER);
			
			mStateList.length = 0;
			
			mStateList.push(new State(EState.IDLE, PlayerAsset.IDLE_PINCER));
			mStateList.push(new State(EState.ATTACK, PlayerAsset.STRIKE_PINCER));
