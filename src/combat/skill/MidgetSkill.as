package combat.skill 
{
	 ...
	 * @author 
	 */
	public class MidgetSkill extends Skill
	{
		...
		public function MidgetSkill() 
		{
			super(ESkill.MIDGET);
			
			mStateList.length = 0;
			
			mStateList.push(new State(EState.IDLE, PlayerAsset.IDLE_MIDGET));
			mStateList.push(new State(EState.ATTACK, PlayerAsset.STRIKE_MIDGET));
