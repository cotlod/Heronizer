package combat.skill 
{
	...
	public class HealerSkill extends Skill
	{
		...
		public function HealerSkill() 
		{
			super(ESkill.HEALER);
			
			mStateList.length = 0;
			
			mStateList.push(new State(EState.IDLE, PlayerAsset.IDLE_HEALER));
			mStateList.push(new State(EState.ATTACK, PlayerAsset.STRIKE_HEALER));
		...
		override public function Update():void 
		{
			...
			{
				var damage:Number = mAttack.Value * 3;
				...
				dispatchEvent(new SkillEvent(SkillEvent.STAT_MODIFIER, EStat.HEALTH, damage, ETarget.SELF));
				mAttackTimer = 0;
			}
